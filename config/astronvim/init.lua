...
local config = {
	...
	mappings = {
		...
		n = {
			...
			-- quick save
			["<leader>sf"] = { ":w!<cr>", desc = "Save File" }, -- change description but the same command
		},
		t = {
		...
		[""] = {
			["<leader>sf"] = { "<Esc>:w!<cr>", desc = "Save File" }, -- change description but the same command
		},
	},
	...
	plugins = {
		...
		treesitter = { -- overrides `require("treesitter").setup(...)`
			ensure_installed = { "lua", "javascript", "typescript", "yaml", "java", "html", "json" },
		},
